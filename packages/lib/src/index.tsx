...
export default class ReactIssueBox extends Component<ReactIssueBoxProps> {
  ...
  render() {
    const { className, contentClassName, children, hoverAble, ...rest } = this.props;
    return (
      <section data-component={CLASS_NAME} data-hoverable={hoverAble} className={cx(CLASS_NAME, className)} {...rest}>
